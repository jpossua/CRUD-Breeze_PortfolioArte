...
<head>
    ...
    <title>Portfolio de Arte | Restablecer Contraseña</title>
...
<body>
    ...
    <div class="glass-card p-5" style="max-width: 450px; width: 100%;">
        <div class="text-center mb-4">
            <span class="material-symbols-outlined text-primary-custom fs-1 mb-2">key</span>
            <h2 class="fw-bold fs-4">Restablecer Contraseña</h2>
        </div>
        ...
        <form method="POST" action="{{ route('password.store') }}">
            ...
            <div class="mb-3">
                ...
                <input type="email" name="email" id="email" value="{{ old('email', $request->email) }}" required
                    autofocus class="form-control form-control-glass">
                @error('email')
            ...
            <div class="mb-4">
                ...
                <input type="password" name="password_confirmation" id="password_confirmation" required
                    autocomplete="new-password" class="form-control form-control-glass">
