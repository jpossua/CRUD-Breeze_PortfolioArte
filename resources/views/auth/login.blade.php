...
<head>
    ...
    <title>Mi Portafolio de Arte | Login</title>
        ...
        <div class="row g-0 full-height">
            ...
            <div class="col-md-7 d-none d-md-flex align-items-center justify-content-center illustration-bg">
                ...
                <div class="glass-card p-5 position-relative z-2 w-75" style="max-width: 600px;">
                    <div class="d-flex flex-column gap-3 font-mono small mb-4">
                        ...
                        <div class="lh-sm">
                            <div class="text-primary-custom fw-bold"><span class="text-pink">const</span> canvas = <span
                                    class="text-purple">new</span> <span class="text-mint">Studio</span>();</div>
                            <div class="text-secondary ps-3"><span class="text-pink">canvas</span>.addTexture(<span
                                    class="text-primary">'watercolor'</span>);</div>
                            <div class="text-secondary ps-3"><span class="text-pink">canvas</span>.setPalette({</div>
                            <div class="text-secondary ps-5">mint: <span class="text-mint">'#e0f2f1'</span>,</div>
                            <div class="text-secondary ps-5">lavender: <span class="text-purple">'#f3e5f5'</span></div>
                            <div class="text-secondary ps-3">});</div>
                            <div class="text-secondary ps-3"><span class="text-pink">canvas</span>.render();</div>
                        </div>
                    </div>

                    <h2 class="display-5 fw-bold text-dark lh-1">
                        Síntesis de <br />
                        <span class="text-primary-custom fst-italic">Arte</span> & <span
                            class="text-purple">Código</span>
                    </h2>
                    <p class="mt-3 text-secondary fs-5">
                        El espacio de trabajo moderno para desarrolladores creativos. Inicia sesión para acceder a tus
                        pinceles digitales y compilador.
                    </p>
                </div>
            </div>
            ...
            <div
                ...
                <div class="d-none d-md-block position-absolute top-0 end-0 p-4 pe-5">
                    ...
                    <a href="{{ route('register') }}" class="small fw-bold ms-1">Crear Cuenta</a>
                </div>

                <div class="w-100" style="max-width: 400px;">
                    <div class="mb-5">
                        <h1 class="fw-bold text-dark display-6">Ingresa al Estudio</h1>
                        <p class="text-secondary">Bienvenido de nuevo. Por favor, ingresa tus credenciales.</p>
                    </div>

                    @if (session('status'))
                        <div class="alert alert-success mb-4 border-0 bg-success-subtle text-success">
                            {{ session('status') }}
                        </div>
                    @endif
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="mb-4">
                            <label for="email" class="form-label small fw-medium text-dark">Dirección de correo
                                electrónico</label>
                        ...
                        <div class="mb-4">
                            <div class="d-flex justify-content-between align-items-center mb-1">
                                <label for="password" class="form-label small fw-medium text-dark mb-0">Password</label>
                                @if (Route::has('password.request'))
                                    <a href="{{ route('password.request') }}"
                                        class="small fw-bold text-primary-custom opacity-75">¿Olvidaste tu
                                        contraseña?</a>
                                @endif
                            </div>
                            <div class="input-wrapper">
                        ...
                        <div class="mt-4 text-center d-md-none">
                            <p class="small text-secondary">
                                ...
                                <a class="fw-bold text-primary-custom" href="{{ route('register') }}">Crear
                                    Cuenta</a>
                            </p>
                        </div>
                    </form>
